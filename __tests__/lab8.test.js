describe('Basic user flow for SPA ', () => {
  ...
  it('Test3: Clicking first <journal-entry>, new URL should contain /#entry1', async () => {
    ...
    await page.click('journal-entry', { h2: 'You like jazz?' });
  ...
  it('Test5: On first Entry page - checking <entry-page> contents', async () => {
    /*
      ...
      */
        ...
        const entryValue = await entry.getProperty('entry');
        const entryJson = await entryValue.jsonValue();
  ...
  it('Test6: On first Entry page - checking <body> element classes', async () => {
    ...
    const bodyVal = await page.$eval('body', (body) => {
      return body.className;
    });

    expect(bodyVal).toBe('single-entry');
  ...
  it('Test8: On Settings page - checking page header title', async () => {
    ...
    const headerVal = await page.$eval('header > h1', (h) => {
      return h.innerHTML;
    });

    expect(headerVal).toBe('Settings');
  ...
  it('Test16: Verify the entry page contents is correct when chicking on the second entry', async () => {
        ...
        expect(entryJson.content).toBe("Mama always said life was like a box of chocolates. You never know what you're gonna get.");
        expect(entryJson.image.src).toBe('https://s.abcnews.com/images/Entertainment/HT_forrest_gump_ml_140219_4x3_992.jpg');
  ...
  it('Test17: click on the title go to the journal entries page', async() => {
  ...
  it('Test19: Click on the third journal entry and verify the url', async() => {
    await page.click('journal-entry:nth-child(3)');

    const pageURL = page.url();

    expect(pageURL).toBe('http://127.0.0.1:5500/#entry3');
  });
  // create your own test 20
  it('Test20: Verify the title is the third entry', async() => {
    const header = await page.$eval('header > h1', (header) => {
      return header.innerHTML;
    });
